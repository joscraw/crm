...
class ReportSelectedCustomFilters {
...
/*    activatePlugins() {
    ...
    render(data) {
        /*debugger;
        this.$wrapper.html(ReportSelectedCustomFilters.markup(this));*/
        ...
        for(let i = 0; i < customFilters.length; i++) {
           ...
           /* let customFilterJoins = customFilter.customFilterJoins.map((value) => {
            ...
            debugger;
            const html = selectedCustomFilterTemplate(text);
            const $selectedCustomFilterTemplate = $($.parseHTML(html));
            this.$wrapper.append($selectedCustomFilterTemplate);
        }
...
const selectedCustomFilterTemplate = (text) => `
    <div class="card js-selected-column">
        <div class="card-body c-report-widget__card-body">
...
export default ReportSelectedCustomFilters;