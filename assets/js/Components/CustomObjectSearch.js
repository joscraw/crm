...
class CustomObjectSearch {
    ...
    handleKeyupEvent(e) {
        ...
        this.globalEventDispatcher.publish(Settings.Events.CUSTOM_OBJECT_SEARCH_KEY_UP, searchObject);
    }

    render() {
        this.$wrapper.html(CustomObjectSearch.markup(this));
    }
...
export default CustomObjectSearch;