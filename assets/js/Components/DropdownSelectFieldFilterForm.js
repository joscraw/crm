...
class DropdownSelectFieldFilterForm {
    ...
    constructor($wrapper, globalEventDispatcher, portalInternalIdentifier, customObjectInternalName, property) {
        ...
        this.$wrapper.on(
            'click',
            DropdownSelectFieldFilterForm._selectors.radioButton,
            this.handleOperatorRadioButtonClicked.bind(this)
        );

        this.$wrapper.on(
            'submit',
            DropdownSelectFieldFilterForm._selectors.applyFilterForm,
            this.handleNewFilterFormSubmit.bind(this)
        );

        this.$wrapper.on(
            'click',
            DropdownSelectFieldFilterForm._selectors.backToListButton,
    ...
    unbindEvents() {
        ...
        this.$wrapper.off('click', DropdownSelectFieldFilterForm._selectors.backToListButton);
    }
    ...
    render() {
        this.$wrapper.html(DropdownSelectFieldFilterForm.markup(this));
    }
...
export default DropdownSelectFieldFilterForm;