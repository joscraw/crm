...
class SavedFilterSearch {
    ...
    handleKeyupEvent(e) {
        ...
        this.globalEventDispatcher.publish(Settings.Events.SAVED_FILTER_SEARCH_KEY_UP, searchObject);
    }

    render() {
        this.$wrapper.html(SavedFilterSearch.markup(this));
    }
...
export default SavedFilterSearch;