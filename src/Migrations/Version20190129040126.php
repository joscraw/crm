 ...
 */
final class Version20190129040126 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, property_group_id INT NOT NULL, custom_object_id INT NOT NULL, label VARCHAR(255) NOT NULL, internal_name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, field_type VARCHAR(255) NOT NULL, field JSON DEFAULT NULL, required TINYINT(1) NOT NULL, is_column TINYINT(1) NOT NULL, column_order INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_8BF21CDEA0D3ED03 (property_group_id), INDEX IDX_8BF21CDE6917218D (custom_object_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
