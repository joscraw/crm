 ...
 */
final class Version20190620222008 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE marketing_list (id INT AUTO_INCREMENT NOT NULL, custom_object_id INT NOT NULL, portal_id INT NOT NULL, folder_id INT DEFAULT NULL, query LONGTEXT NOT NULL, data JSON NOT NULL, name VARCHAR(255) NOT NULL, column_order JSON NOT NULL, type VARCHAR(255) NOT NULL, records JSON DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_C6EF1A406917218D (custom_object_id), INDEX IDX_C6EF1A40B887E1DD (portal_id), INDEX IDX_C6EF1A40162CB942 (folder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE form (id INT AUTO_INCREMENT NOT NULL, custom_object_id INT DEFAULT NULL, portal_id INT DEFAULT NULL, data JSON DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, uid VARCHAR(255) NOT NULL, published TINYINT(1) NOT NULL, draft JSON DEFAULT NULL, submission_count INT DEFAULT NULL, submit_action VARCHAR(255) DEFAULT NULL, submit_message LONGTEXT DEFAULT NULL, redirect_url VARCHAR(255) DEFAULT NULL, cookie_tracking TINYINT(1) NOT NULL, recaptcha TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_5288FD4F6917218D (custom_object_id), INDEX IDX_5288FD4FB887E1DD (portal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE form DROP FOREIGN KEY FK_5288FD4F6917218D');
        ...
        $this->addSql('ALTER TABLE form DROP FOREIGN KEY FK_5288FD4FB887E1DD');
