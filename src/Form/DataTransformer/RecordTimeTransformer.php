...
class RecordTimeTransformer implements DataTransformerInterface
{
    use ArrayHelper;
    ...
    public function transform($date)
    {
        ...
        $date = \DateTime::createFromFormat(DatePickerField::$timeStoredFormat, $date);
    ...
    public function reverseTransform($date)
    {
        ...
        return $date->format(DatePickerField::$timeStoredFormat);
